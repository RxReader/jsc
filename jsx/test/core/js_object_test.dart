...
void main() {
  ...
  test('JSObject.makeFunction', () {
    ...
    globalContext.globalObject.setProperty('_flutter_inject_js_hello', func1.value);
    final JSObject func2 = globalContext.globalObject.getProperty('_flutter_inject_js_hello').object;
