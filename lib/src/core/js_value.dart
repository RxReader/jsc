...
import 'package:jsc/src/bindings/js_value_ref.dart' as jsc_bd;
import 'package:jsc/src/core/js_class.dart';
import 'package:jsc/src/core/js_context.dart';
import 'package:jsc/src/core/js_error.dart';
...
class JSValue {
  ...
  factory JSValue.makeUndefined(JSContext context) {
    return JSValue(context, jsc_bd.JSValueMakeUndefined(context.ref));
  }

  factory JSValue.makeNull(JSContext context) {
    return JSValue(context, jsc_bd.JSValueMakeNull(context.ref));
  }
  ...
  factory JSValue.makeBoolean(
    ...
    return JSValue(context, jsc_bd.JSValueMakeBoolean(context.ref, boolean));
  }
  ...
  factory JSValue.makeNumber(
    ...
    return JSValue(context, jsc_bd.JSValueMakeNumber(context.ref, number));
  }
  ...
  factory JSValue.makeString(
    ...
    try {
      return JSValue(context, jsc_bd.JSValueMakeString(context.ref, jsString.ref));
    } finally {
      jsString.release();
    }
  }
  ...
  factory JSValue.makeSymbol(
    ...
    try {
      return JSValue(context, jsc_bd.JSValueMakeSymbol(context.ref, jsString.ref));
    } finally {
      jsString.release();
    }
  }
  ...
  factory JSValue.makeFromJSONString(
    ...
    try {
      return JSValue(context, jsc_bd.JSValueMakeFromJSONString(context.ref, jsString.ref));
    } finally {
      jsString.release();
    }
  }
  ...
  JSType get type {
    final int type = jsc_bd.JSValueGetType(_context.ref, _ref);
    return JSType.values[type];
  }

  bool get isUndefined {
    return jsc_bd.JSValueIsUndefined(_context.ref, _ref);
  }

  bool get isNull {
    return jsc_bd.JSValueIsNull(_context.ref, _ref);
  }

  bool get isBoolean {
    return jsc_bd.JSValueIsBoolean(_context.ref, _ref);
  }

  bool get isNumber {
    return jsc_bd.JSValueIsNumber(_context.ref, _ref);
  }

  bool get isString {
    return jsc_bd.JSValueIsString(_context.ref, _ref);
  }

  // iOS 13.0
  bool get isSymbol {
    return jsc_bd.JSValueIsSymbol(_context.ref, _ref);
  }

  bool get isObject {
    return jsc_bd.JSValueIsObject(_context.ref, _ref);
  }

  bool isObjectOfClass(JSClass clazz) {
    return jsc_bd.JSValueIsObjectOfClass(_context.ref, _ref, clazz.ref);
  }

  // iOS 9.0
  bool get isArray {
    return jsc_bd.JSValueIsArray(_context.ref, _ref);
  }

  // iOS 9.0
  bool get isDate {
    return jsc_bd.JSValueIsDate(_context.ref, _ref);
  }

  bool get isPromise {
    final JSObject func;
    if (_context.globalObject.hasProperty('_flutter_jsc_inject_isPromise')) {
      func = _context.globalObject.getProperty('_flutter_jsc_inject_isPromise').object;
    } else {
      ...
      _context.globalObject.setProperty('_flutter_jsc_inject_isPromise', func.value);
    }
  ...
  bool get isError {
    final JSObject func;
    if (_context.globalObject.hasProperty('_flutter_jsc_inject_isError')) {
      func = _context.globalObject.getProperty('_flutter_jsc_inject_isError').object;
    } else {
      func = JSObject.makeFunction(
        _context,
        parameterNames: <String>['v'],
      ...
      _context.globalObject.setProperty('_flutter_jsc_inject_isError', func.value);
    }
    final JSValue result = func.callAsFunction(arguments: <JSValue>[this]);
    return result.isBoolean && result.boolean;
  }
  ...
  bool get isRegExp {
    final JSObject func;
    if (_context.globalObject.hasProperty('_flutter_jsc_inject_isRegExp')) {
      func = _context.globalObject.getProperty('_flutter_jsc_inject_isRegExp').object;
    } else {
      func = JSObject.makeFunction(
        _context,
        parameterNames: <String>['v'],
      ...
      _context.globalObject.setProperty('_flutter_jsc_inject_isRegExp', func.value);
    }
    final JSValue result = func.callAsFunction(arguments: <JSValue>[this]);
    return result.isBoolean && result.boolean;
  }
  ...
  JSTypedArrayType get typedArrayType {
    ...
    try {
      final int type = jsc_bd.JSValueGetTypedArrayType(_context.ref, _ref, exception.ref);
  ...
  bool isEqual(JSValue other) {
    final JSException exception = JSException.create(_context);
    try {
      final bool result = jsc_bd.JSValueIsEqual(_context.ref, _ref, other.ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return result;
  ...
  bool isInstanceOfConstructor(JSObject constructor) {
    final JSException exception = JSException.create(_context);
    try {
      final bool result = jsc_bd.JSValueIsInstanceOfConstructor(_context.ref, _ref, constructor.ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return result;
  ...
  JSString createJSONString({
    ...
    final JSException exception = JSException.create(_context);
    try {
      final JSStringRef stringRef = jsc_bd.JSValueCreateJSONString(_context.ref, _ref, indent, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
  ...
  bool get boolean {
    return jsc_bd.JSValueToBoolean(_context.ref, _ref);
  }

  double get number {
    final JSException exception = JSException.create(_context);
    try {
      final double result = jsc_bd.JSValueToNumber(_context.ref, _ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return result;
  ...
  JSString get stringCopy {
    final JSException exception = JSException.create(_context);
    try {
      final JSStringRef stringRef = jsc_bd.JSValueToStringCopy(_context.ref, _ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return JSString(stringRef);
  ...
  JSObject get object {
    final JSException exception = JSException.create(_context);
    try {
      final JSObjectRef objectRef = jsc_bd.JSValueToObject(_context.ref, _ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
  ...
  void protect() {
    jsc_bd.JSValueProtect(_context.ref, _ref);
  }

  void unprotect() {
    jsc_bd.JSValueUnprotect(_context.ref, _ref);
  }

  @override
  bool operator ==(Object other) => identical(this, other) || other is JSValue && runtimeType == other.runtimeType && jsc_bd.JSValueIsStrictEqual(_context.ref, ref, other.ref);
