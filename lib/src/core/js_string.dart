...
import 'package:jsc/src/bindings/js_string_ref.dart' as jsc_bd;
...
class JSString {
  ...
  factory JSString.fromString(String string) {
    ...
    try {
      return JSString(jsc_bd.JSStringCreateWithUTF8CString(cstring));
    } finally {
      malloc.free(cstring);
    }
  }
  ...
  JSString retain() {
    return JSString(jsc_bd.JSStringRetain(_ref));
  }

  void release() {
    if (_ref != nullptr) {
      jsc_bd.JSStringRelease(_ref);
    }
  }

  int get length {
    return jsc_bd.JSStringGetLength(_ref);
  }
  ...
  String? get string {
    ...
    final Pointer<jsc_bd.JSChar> characters = jsc_bd.JSStringGetCharactersPtr(_ref);
    if (characters == nullptr) {
      return null;
    }
    final int charactersLength = jsc_bd.JSStringGetLength(_ref);
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is JSString && runtimeType == other.runtimeType && jsc_bd.JSStringIsEqual(_ref, other.ref);
