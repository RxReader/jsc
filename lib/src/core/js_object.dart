...
import 'package:jsc/src/bindings/js_base.dart' hide JSTypedArrayBytesDeallocator;
import 'package:jsc/src/bindings/js_base.dart' as jsc_bd show JSTypedArrayBytesDeallocator;
import 'package:jsc/src/bindings/js_object_ref.dart' as jsc_bd;
import 'package:jsc/src/bindings/js_typed_array.dart' as jsc_bd;
import 'package:jsc/src/core/js_class.dart';
import 'package:jsc/src/core/js_context.dart';
import 'package:jsc/src/core/js_property_name_accumulator.dart';
import 'package:jsc/src/core/js_property_name_array.dart';
import 'package:jsc/src/core/js_string.dart';
import 'package:jsc/src/core/js_typed_array.dart';
...
class JSStaticValue {
  ...
  final String name;
  final Pointer<NativeFunction<jsc_bd.JSObjectGetPropertyCallback>>? getProperty;
  final Pointer<NativeFunction<jsc_bd.JSObjectSetPropertyCallback>>? setProperty;
  final JSPropertyAttributes attributes;
}

extension JSStaticValueDelegate on JSStaticValue {
  jsc_bd.JSStaticValueDelegate toDelegate() {
    return jsc_bd.JSStaticValueDelegate(
      name.toNativeUtf8(),
      getProperty,
      setProperty,
...
extension JSStaticValueExtension on JSStaticValue {
  Pointer<jsc_bd.JSStaticValue> get ref {
    return jsc_bd.JSStaticValue.allocate(toDelegate());
  }
}

extension JSStaticValueIterable on Iterable<JSStaticValue> {
  Pointer<jsc_bd.JSStaticValue> get ref {
    return jsc_bd.JSStaticValue.allocateArray(map((JSStaticValue element) => element.toDelegate()));
  }
}
...
class JSStaticFunction {
  ...
  final String name;
  final Pointer<NativeFunction<jsc_bd.JSObjectCallAsFunctionCallback>>? callAsFunction;
  final JSPropertyAttributes attributes;
}

extension JSStaticFunctionDelegate on JSStaticFunction {
  jsc_bd.JSStaticFunctionDelegate toDelegate() {
    return jsc_bd.JSStaticFunctionDelegate(
      name.toNativeUtf8(),
      callAsFunction,
      JSPropertyAttributes.values.indexOf(attributes),
    );
...
extension JSStaticFunctionExtension on JSStaticFunction {
  Pointer<jsc_bd.JSStaticFunction> get ref {
    return jsc_bd.JSStaticFunction.allocate(toDelegate());
  }
}

extension JSStaticFunctionIterable on Iterable<JSStaticFunction> {
  Pointer<jsc_bd.JSStaticFunction> get ref {
    return jsc_bd.JSStaticFunction.allocateArray(map((JSStaticFunction element) => element.toDelegate()));
  }
}

class JSClassDefinition {
  const JSClassDefinition(
    Pointer<jsc_bd.JSClassDefinition> ref,
    Pointer<jsc_bd.JSStaticValue>? staticValuesRef,
    Pointer<jsc_bd.JSStaticFunction>? staticFunctionsRef,
  )   : _ref = ref,
  ...
  factory JSClassDefinition.create({
    ...
    Pointer<NativeFunction<jsc_bd.JSObjectInitializeCallback>>? initialize,
    Pointer<NativeFunction<jsc_bd.JSObjectFinalizeCallback>>? finalize,
    Pointer<NativeFunction<jsc_bd.JSObjectHasPropertyCallback>>? hasProperty,
    Pointer<NativeFunction<jsc_bd.JSObjectGetPropertyCallback>>? getProperty,
    Pointer<NativeFunction<jsc_bd.JSObjectSetPropertyCallback>>? setProperty,
    Pointer<NativeFunction<jsc_bd.JSObjectDeletePropertyCallback>>? deleteProperty,
    Pointer<NativeFunction<jsc_bd.JSObjectGetPropertyNamesCallback>>? getPropertyNames,
    Pointer<NativeFunction<jsc_bd.JSObjectCallAsFunctionCallback>>? callAsFunction,
    Pointer<NativeFunction<jsc_bd.JSObjectCallAsConstructorCallback>>? callAsConstructor,
    Pointer<NativeFunction<jsc_bd.JSObjectHasInstanceCallback>>? hasInstance,
    Pointer<NativeFunction<jsc_bd.JSObjectConvertToTypeCallback>>? convertToType,
  }) {
    final Pointer<jsc_bd.JSStaticValue>? staticValuesRef = staticValues?.ref;
    final Pointer<jsc_bd.JSStaticFunction>? staticFunctionsRef = staticFunctions?.ref;
    return JSClassDefinition(
      jsc_bd.JSClassDefinition.allocate(
        version,
  ...
  final Pointer<jsc_bd.JSClassDefinition> _ref;
  final Pointer<jsc_bd.JSStaticValue>? _staticValuesRef;
  final Pointer<jsc_bd.JSStaticFunction>? _staticFunctionsRef;
...
extension JSClassDefinitionExtension on JSClassDefinition {
  Pointer<jsc_bd.JSClassDefinition> get ref => _ref;
}
...
class JSObject {
  ...
  factory JSObject.make(
    ...
    return JSObject(
      context,
      jsc_bd.JSObjectMake(context.ref, clazz?.ref ?? nullptr, data ?? nullptr),
    );
  }
  ...
  factory JSObject.makeFunctionWithCallback(
    ...
    try {
      return JSObject(
        context,
        jsc_bd.JSObjectMakeFunctionWithCallback(
          context.ref,
          jsName?.ref ?? nullptr,
          callAsFunction ?? nullptr,
        ),
  ...
  factory JSObject.makeConstructor(
    ...
    return JSObject(
      context,
      jsc_bd.JSObjectMakeConstructor(
        context.ref,
        clazz?.ref ?? nullptr,
        callAsConstructor ?? nullptr,
      ),
  ...
  factory JSObject.makeArray(
    ...
    try {
      final JSObject object = JSObject(context, jsc_bd.JSObjectMakeArray(context.ref, arguments?.length ?? 0, arguments?.ref ?? nullptr, exception.ref));
  ...
  factory JSObject.makeDate(
    ...
    final JSException exception = JSException.create(context);
    try {
      final JSObject object = JSObject(context, jsc_bd.JSObjectMakeDate(context.ref, arguments?.length ?? 0, arguments?.ref ?? nullptr, exception.ref));
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return object;
  ...
  factory JSObject.makeError(
    ...
    final JSException exception = JSException.create(context);
    try {
      final JSObject object = JSObject(context, jsc_bd.JSObjectMakeError(context.ref, arguments?.length ?? 0, arguments?.ref ?? nullptr, exception.ref));
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return object;
  ...
  factory JSObject.makeRegExp(
    ...
    final JSException exception = JSException.create(context);
    try {
      final JSObject object = JSObject(context, jsc_bd.JSObjectMakeRegExp(context.ref, arguments?.length ?? 0, arguments?.ref ?? nullptr, exception.ref));
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return object;
  ...
  factory JSObject.makeDeferredPromise(
    ...
    final JSException exception = JSException.create(context);
    try {
      final JSObject object = JSObject(context, jsc_bd.JSObjectMakeDeferredPromise(context.ref, resolve?.ref ?? nullptr, reject?.ref ?? nullptr, exception.ref));
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return object;
  ...
  factory JSObject.makeTypedArray(
    ...
    final JSException exception = JSException.create(context);
    try {
      final JSObject object = JSObject(context, jsc_bd.JSObjectMakeTypedArray(context.ref, JSTypedArrayType.values.indexOf(arrayType), length, exception.ref));
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return object;
  ...
  factory JSObject.makeTypedArrayWithBytesNoCopy(
    ...
    Pointer<NativeFunction<jsc_bd.JSTypedArrayBytesDeallocator>>? bytesDeallocator,
    ...
    try {
      final JSObject object = JSObject(
        context,
        jsc_bd.JSObjectMakeTypedArrayWithBytesNoCopy(
          context.ref,
  ...
  factory JSObject.makeTypedArrayWithArrayBuffer(
    ...
    final JSException exception = JSException.create(context);
    try {
      final JSObject object = JSObject(context, jsc_bd.JSObjectMakeTypedArrayWithArrayBuffer(context.ref, JSTypedArrayType.values.indexOf(arrayType), buffer.ref, exception.ref));
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return object;
  ...
  factory JSObject.makeTypedArrayWithArrayBufferAndOffset(
    ...
    try {
      final JSObject object = JSObject(
        context,
        jsc_bd.JSObjectMakeTypedArrayWithArrayBufferAndOffset(
          context.ref,
          JSTypedArrayType.values.indexOf(arrayType),
          buffer.ref,
          byteOffset,
  ...
  factory JSObject.makeArrayBufferWithBytesNoCopy(
    ...
    try {
      final JSObject object = JSObject(
        context,
        jsc_bd.JSObjectMakeArrayBufferWithBytesNoCopy(
          context.ref,
          bytes.bytes,
          bytes.length,
          bytesDeallocator ?? nullptr,
  ...
  JSValue get prototype {
    return JSValue(_context, jsc_bd.JSObjectGetPrototype(_context.ref, _ref));
  }

  set prototype(JSValue value) {
    jsc_bd.JSObjectSetPrototype(_context.ref, _ref, value.ref);
  }

  bool hasProperty(String propertyName) {
    final JSString jsPropertyName = JSString.fromString(propertyName);
    try {
      return jsc_bd.JSObjectHasProperty(_context.ref, _ref, jsPropertyName.ref);
    } finally {
  ...
  JSValue getProperty(String propertyName) {
    ...
    final JSString jsPropertyName = JSString.fromString(propertyName);
    try {
      final JSValueRef valueRef = jsc_bd.JSObjectGetProperty(_context.ref, _ref, jsPropertyName.ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
  ...
  void setProperty(String propertyName, JSValue? value, {JSPropertyAttributes attributes = JSPropertyAttributes.kJSPropertyAttributeNone}) {
    ...
    final JSString jsPropertyName = JSString.fromString(propertyName);
    try {
      jsc_bd.JSObjectSetProperty(_context.ref, _ref, jsPropertyName.ref, value?.ref ?? nullptr, JSPropertyAttributes.values.indexOf(attributes), exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
    } finally {
  ...
  bool deleteProperty(String propertyName) {
    ...
    final JSString jsPropertyName = JSString.fromString(propertyName);
    try {
      final bool result = jsc_bd.JSObjectDeleteProperty(_context.ref, _ref, jsPropertyName.ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return result;
  ...
  bool hasPropertyForKey(JSValue propertyKey) {
    final JSException exception = JSException.create(_context);
    try {
      final bool result = jsc_bd.JSObjectHasPropertyForKey(_context.ref, _ref, propertyKey.ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return result;
  ...
  JSValue getPropertyForKey(JSValue propertyKey) {
    final JSException exception = JSException.create(_context);
    try {
      final JSValueRef valueRef = jsc_bd.JSObjectGetPropertyForKey(_context.ref, _ref, propertyKey.ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return JSValue(_context, valueRef);
  ...
  void setPropertyForKey(JSValue propertyKey, JSValue? value, {JSPropertyAttributes attributes = JSPropertyAttributes.kJSPropertyAttributeNone}) {
    final JSException exception = JSException.create(_context);
    try {
      jsc_bd.JSObjectSetPropertyForKey(_context.ref, _ref, propertyKey.ref, value?.ref ?? nullptr, JSPropertyAttributes.values.indexOf(attributes), exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
    } finally {
  ...
  void deletePropertyForKey(JSValue propertyKey) {
    final JSException exception = JSException.create(_context);
    try {
      jsc_bd.JSObjectDeletePropertyForKey(_context.ref, _ref, propertyKey.ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
    } finally {
  ...
  JSValue getPropertyAtIndex(int propertyIndex) {
    final JSException exception = JSException.create(_context);
    try {
      final JSValueRef valueRef = jsc_bd.JSObjectGetPropertyAtIndex(_context.ref, _ref, propertyIndex, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return JSValue(_context, valueRef);
  ...
  void setPropertyAtIndex(int propertyIndex, JSValue value) {
    final JSException exception = JSException.create(_context);
    try {
      jsc_bd.JSObjectSetPropertyAtIndex(_context.ref, _ref, propertyIndex, value.ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
    } finally {
  ...
  Pointer<Void> getPrivate() {
    return jsc_bd.JSObjectGetPrivate(_ref);
  }

  bool setPrivate(Pointer<Void> data) {
    return jsc_bd.JSObjectSetPrivate(_ref, data);
  }

  bool get isFunction {
    return jsc_bd.JSObjectIsFunction(_context.ref, _ref);
  }

  JSValue callAsFunction({JSObject? thisObject, List<JSValue>? arguments}) {
    final JSException exception = JSException.create(_context);
    try {
      final JSValueRef valueRef = jsc_bd.JSObjectCallAsFunction(_context.ref, _ref, thisObject?.ref ?? nullptr, arguments?.length ?? 0, arguments?.ref ?? nullptr, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return JSValue(_context, valueRef);
  ...
  bool get isConstructor {
    return jsc_bd.JSObjectIsConstructor(_context.ref, _ref);
  }

  JSObject callAsConstructor({List<JSValue>? arguments}) {
    final JSException exception = JSException.create(_context);
    final JSObjectRef objectRef = jsc_bd.JSObjectCallAsConstructor(_context.ref, _ref, arguments?.length ?? 0, arguments?.ref ?? nullptr, exception.ref);
    if (exception.shouldThrow) {
      throw exception.error;
    }
  ...
  JSPropertyNameArray copyPropertyNames() {
    return JSPropertyNameArray(jsc_bd.JSObjectCopyPropertyNames(_context.ref, _ref));
  }
  ...
  JSTypedArrayBytes get typedArrayBytes {
    ...
    try {
      final Pointer<Void> bytes = jsc_bd.JSObjectGetTypedArrayBytesPtr(_context.ref, _ref, exception1.ref);
      if (exception1.shouldThrow) {
        throw exception1.error;
      }
      final int length = jsc_bd.JSObjectGetTypedArrayLength(_context.ref, _ref, exception2.ref);
  ...
  int get typedArrayByteLength {
    final JSException exception = JSException.create(_context);
    try {
      final int length = jsc_bd.JSObjectGetTypedArrayByteLength(_context.ref, _ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return length;
  ...
  int get typedArrayByteOffset {
    final JSException exception = JSException.create(_context);
    try {
      final int offset = jsc_bd.JSObjectGetTypedArrayByteOffset(_context.ref, _ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return offset;
  ...
  JSObject get typedArrayBuffer {
    final JSException exception = JSException.create(_context);
    try {
      final JSObjectRef objectRef = jsc_bd.JSObjectGetTypedArrayBuffer(_context.ref, _ref, exception.ref);
      if (exception.shouldThrow) {
        throw exception.error;
      }
      return JSObject(_context, objectRef);
  ...
  JSTypedArrayBytes get arrayBufferBytes {
    ...
    final JSException exception2 = JSException.create(_context);
    try {
      final Pointer<Void> bytes = jsc_bd.JSObjectGetArrayBufferBytesPtr(_context.ref, _ref, exception1.ref);
      if (exception1.shouldThrow) {
        throw exception1.error;
      }
      final int length = jsc_bd.JSObjectGetArrayBufferByteLength(_context.ref, _ref, exception2.ref);
      if (exception2.shouldThrow) {
        throw exception2.error;
      }
      return JSTypedArrayBytes(bytes, length);
